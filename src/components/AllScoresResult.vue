    ...
    <div v-if="allScoresData" class="scores-content">
      ...
      <div class="user-info">
        ...
        <div class="print-only-info">
          <p>用户名: {{ allScoresData.username || '未设置' }} | Rating: {{ allScoresData.rating || 0 }} | 数据来源：diving-fish | Generated by 宇航员Dale</p>
      ...
      <div v-if="displayMode" class="charts-section">
        <div class="charts-header">
          <div class="header-left">
            ...
            <!-- 页码信息紧挨着标题 -->
            <span class="page-info print-only">第 {{ currentPage }} 页 / 共 {{ totalPages }} 页</span>
          </div>
          <!-- 每页数量选择 -->
          <div class="page-size-control screen-only">
            <span>每页显示：</span>
...
export default {
  ...
  setup(props) {
    ...
    const totalPages = computed(() => {
      return Math.ceil(filteredScores.value.length / pageSize.value);
    });
